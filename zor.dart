  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text("Zor", style: TextStyle(fontSize: 25),)
      ),
      body: Center(
        child: Container(
